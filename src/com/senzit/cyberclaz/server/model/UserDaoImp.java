...
public class UserDaoImp implements UserDao 
{
	...
	public List<Object[]> getUserNameFromBatch(CourseBatch batch) {
		...
		String hql="select u.userId,u.profilePic,u.firstName from User u,StudentBatch sb where sb.courseBatch=:batch"
				+" and u.userId=sb.userId";
		return sessionFactory.getCurrentSession().createQuery(hql)
	...
	@Override
	public String saveDetailsInDB(String userId,String firstName,String emailId,String mobileNumber,String registered,String profilePic) {
