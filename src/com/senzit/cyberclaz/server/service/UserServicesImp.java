...
public class UserServicesImp implements UserServices 
{
	...
	@Override
	public boolean saveDetailsInDB(String userId,String firstName,String emailId,String mobileNumber,String registered,String profilePic)
	{
		
	   String result=userDao.saveDetailsInDB(userId,firstName,emailId,mobileNumber,registered,profilePic);
	   if(result!=null)
	   {
...
//			return userDao.updateProPic(userId, null);
	...
	public void insertUserDetails(String userId,String password) {
		   String result=userDao.saveDetailsInDB(userId,password,"aadffd","145236887777","rfgfg","http://81.95.159.34:8080/ProfilePic/a10.png");
		   if(result!=null)
		   {
		    System.out.println("values saved in DB");
